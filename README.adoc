...
This guide provides a concise overview of essential cryptographic operations using Rust. It is designed as a quick reference for developers who want a practical summary of common tasks such as hashing, encryption, key generation, and digital signatures. Whether you are new to cryptography in Rust or just need a refresher, this tutorial will help you get up and running quickly with clear examples and minimal setup.
...
//** Recommendation: Not suitable for new projects.
//* *ring*
//** Status: Actively maintained and widely adopted
//** Highlights:
//*** High performance and security
//*** Backed by BoringSSL primitives
//*** Suitable for production environments where performance and battle-tested //implementations are critical
//* *RustCrypto*
//** Status: Actively maintained
//** Highlights:
//*** A modular suite of cryptographic crates written entirely in Rust (no FFI to C //libraries)
//*** Flexible: use only the algorithms you need
//*** Safe, readable, and performant
//** Example of Rust crates:
//*** aes: AES encryption
//*** sha2: SHA-2 hashing
...
This short tutorial will focus on using RustCrypto to demonstrate practical examples of hashing, symmetric encryption, message authentication, and public-key cryptography, all using idiomatic Rust.
...
In the following I present practical examples of how to use some of these primitives.
