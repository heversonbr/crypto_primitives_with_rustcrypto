...
pub fn key_exchange_ecdh_example_2() {
    ...
    let bob_public_key = PublicKey::from_sec1_bytes(bob_public_bytes.as_ref())
                    .expect("Bob's public key is invalid!");
    let alice_public_key = PublicKey::from_sec1_bytes(alice_public_bytes.as_ref())
